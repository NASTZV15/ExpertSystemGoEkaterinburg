    ...
    public partial class Options : Form
    {
        ...
        public Options(List<Rule> RulesList)
        {
            ...
            foreach (string option in RulesList.Select(r => r.option).Distinct().ToList())
            {
                ...
                options[i].Font = new System.Drawing.Font("Tahoma", 11.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                options[i].Location = new System.Drawing.Point(6, 20 + 30 * i);
